...
if __name__ == '__main__':
    ...
    parser.add_argument('--modality_missing_type', type=str, default='randlike', help='modality missing type: zerolike, randlike')
    ...
    parser.add_argument('--alpha_distance', type=float, default=0.001, help='alpha_diatance')
